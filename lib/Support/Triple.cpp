...
StringRef Triple::getArchTypeName(ArchType Kind) {
  ...
  case riscvxvec32:    return "riscvxvec32";
  case riscvxvec64:    return "riscvxvec64";
...
StringRef Triple::getArchTypePrefix(ArchType Kind) {
  ...
  case riscvxvec32:
  case riscvxvec64:     return "riscvxvec2";
  }
}
...
Triple::ArchType Triple::getArchTypeForLLVMName(StringRef Name) {
  ...
  return StringSwitch<Triple::ArchType>(Name)
    ...
    .Case("riscvxvec32", riscvxvec32)
    .Case("riscvxvec64", riscvxvec64)
...
static Triple::ArchType parseArch(StringRef ArchName) {
  auto AT = StringSwitch<Triple::ArchType>(ArchName)
    ...
    .Case("riscvxvec32", Triple::riscvxvec32)
    .Case("riscvxvec64", Triple::riscvxvec64)
...
static Triple::ObjectFormatType getDefaultFormat(const Triple &T) {
  ...
  case Triple::riscv32:
  case Triple::riscv64:
  case Triple::riscvxvec32:
  case Triple::riscvxvec64:
  case Triple::shave:
  case Triple::sparc:
  case Triple::sparcel:
  case Triple::sparcv9:
...
Triple Triple::get32BitArchVariant() const {
  ...
  case Triple::riscvxvec64:    T.setArch(Triple::riscvxvec32); break;
...
Triple Triple::get64BitArchVariant() const {
  ...
  case Triple::riscvxvec32:     T.setArch(Triple::riscvxvec64); break;
